...
func (u *ConfirmPickupUsecase) ConfirmPickup(ctx context.Context, loadID string, userID string, req *ConfirmPickupRequest) (err error) {
	...
	history, err := load.ConfirmPickup(req.Note, input.attachmentIDs...)
	if err != nil {
