// Package shipper Code generated by swaggo/swag. DO NOT EDIT
package shipper

import "github.com/swaggo/swag"

const docTemplateshipper = `{
        ...
        "/attachments/file": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Visibility of attachment",
                        "name": "visibility",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Folder to upload attachment",
                        "name": "folder",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/command.UploadFileResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/command.UploadImageResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/query.AttachmentResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
...
// SwaggerInfoshipper holds exported Swagger Info so clients can modify it
var SwaggerInfoshipper = &swag.Spec{
	Version:          "",
	Host:             "",
	BasePath:         "/api/v1",
	Schemes:          []string{},
	Title:            "Shippers API",
	Description:      "",
	InfoInstanceName: "shipper",
	SwaggerTemplate:  docTemplateshipper,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfoshipper.InstanceName(), SwaggerInfoshipper)
}
