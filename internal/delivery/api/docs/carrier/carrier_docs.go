// Package carrier Code generated by swaggo/swag. DO NOT EDIT
package carrier

import "github.com/swaggo/swag"

const docTemplatecarrier = `{
...
// SwaggerInfocarrier holds exported Swagger Info so clients can modify it
var SwaggerInfocarrier = &swag.Spec{
	Version:          "",
	Host:             "",
	BasePath:         "/api/v1",
	Schemes:          []string{},
	Title:            "Carriers API",
	Description:      "",
	InfoInstanceName: "carrier",
	SwaggerTemplate:  docTemplatecarrier,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfocarrier.InstanceName(), SwaggerInfocarrier)
}
